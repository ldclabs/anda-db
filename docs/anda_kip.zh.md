...
追踪 KIP 提交 `11a82ec`，包含草案记忆包 `kip://profiles/cognitive-memory@2.0.0`（内容摘要 `sha256:734aa0fd…`）以及严格的 UTC 毫秒时间戳契约（§6.5）。有关已实现的契约和能力边界，请参阅 [Cognitive Nexus 文档](anda_cognitive_nexus.zh.md)。
